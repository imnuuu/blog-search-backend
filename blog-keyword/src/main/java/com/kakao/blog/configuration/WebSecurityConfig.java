...
import com.kakao.blog.common.constants.Constants.KeywordPath;
...
public class WebSecurityConfig{
    ...
    private void authorizationConfigure(
      ExpressionUrlAuthorizationConfigurer<HttpSecurity>.ExpressionInterceptUrlRegistry authorization) {
        authorization
          .antMatchers(KeywordPath.APIS_PATH).permitAll()
          .antMatchers(KeywordPath.HEALTH_PATH, KeywordPath.METRICS_PATH, KeywordPath.FAVICON_ICO_PATH).permitAll()
